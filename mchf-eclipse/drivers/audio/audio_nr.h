...
{
 	float32_t 					last_iFFT_result     [NR_FFT_L_2 / 2];   // NIZZ on a plus besoin, on prend le milieu de la FFT-Inv a la sortie
...
int     NR_in_buffer_add   ( NR_Buffer*  c     );  /* no room left in the buffer returns 0 */
