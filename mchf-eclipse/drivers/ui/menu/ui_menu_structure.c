...
const MenuDescriptor topGroup[] =
{
	...
	{ MENU_TOP, MENU_GROUP, MENU_AGC_WDSP    , NULL, "AGC (RX) Settings"    , UiMenuDesc("AGC WDSP Settings ") },
	{ MENU_TOP, MENU_GROUP, MENU_FILTER      , NULL, "RX Filter & Equaliz"  , UiMenuDesc("Select the filters for filter button by mode. Each mode can have up to 4 filters for quick selection via short press Filter button G4.") },
	{ MENU_TOP, MENU_GROUP, MENU_TX_FILTER   , NULL, "TX Filter & Equaliz"  , UiMenuDesc("Select the Tx parametric equalizer filters Basse/ Treble .") },
	{ MENU_TOP, MENU_GROUP, MENU_COMPRESS    , NULL, "Compressor & Inputs"  , UiMenuDesc("Inputs  &  compressor Settings ") },
	...
	{ MENU_TOP, MENU_GROUP, MENU_DSP         , NULL, "DSP Functions Menu"   , UiMenuDesc("DSP Functions Settings ") },
...
//  { MENU_BASE, MENU_ITEM, MENU_SSB_NARROW_FILT        , "029","CW Filt in SSB Mode"    , UiMenuDesc(":soon:") },
	...
	{ MENU_BASE, MENU_ITEM, MENU_ANT_ATT_6DB            , NULL, "Antenna Attenuator"     , UiMenuDesc("Sets ON or OFF the Hardware Antenna attenuator -6db ") },
	...
	{ MENU_BASE, MENU_ITEM, CONFIG_MAX_VOLUME           , NULL, "RX Max Speaker Volume"  , UiMenuDesc("Set maximum speaker&headphone volume.") },
	{ MENU_BASE, MENU_ITEM, CONFIG_LINEOUT_GAIN         , NULL, "RX Lineout Gain"        , UiMenuDesc("Set the constant gain level for the analog lineout jack") },
    ...
    { MENU_BASE, MENU_ITEM, MENU_DIGI_DISABLE           , NULL, "Enable DigiModes"       , UiMenuDesc("Disable appearance of digital modes when pressing Mode button")},
	{ MENU_BASE, MENU_ITEM, MENU_DIGITAL_MODE_SELECT    , NULL, "Select DigiMode"        , UiMenuDesc("Select the active digital mode (FreeDV,RTTY, ...).") },
...
//  { MENU_CONF, MENU_ITEM, CONFIG_TX_OUT_ENABLE                , NULL, "TX on Out-Of-Band Freq.", UiMenuDesc("Permit low power transmission even if the frequency is out of the official ham bands. DO NOT USE WITH CONNECTED ANTENNA! Use a dummy load!") },
  ...
  //{ MENU_CONF, MENU_ITEM, CONFIG_MAX_RX_GAIN                  , NULL, "Max RX Gain (0=Max)"    , UiMenuDesc("Here you can set maximum gain for RX. A good choice is 3...5. If set to 0 RX is too sensitive in most working conditions.") },
	...
	{ MENU_CONF, MENU_ITEM, MENU_DYNAMICTUNE                    , NULL, "Dynamic Tune Steps"    , UiMenuDesc("Toggles dynamic tune steps mode to chage freq quickly") },
    ...
    { MENU_CONF, MENU_ITEM, CONFIG_FREQUENCY_CALIBRATE     , NULL, "LO Freq. Calibrate"           , UiMenuDesc("Adjust the frequency correction of the local oscillator. Measure TX frequency and adjust until both match. Or use receive a know reference signal and zero-beat it and then adjust. More information in the Wiki.") },
	...
	{ MENU_CONF, MENU_ITEM, CONFIG_160M_RX_IQ_GAIN_BAL          , &ts.display_rx_iq, "RX IQ Balance (160m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_160M_RX_IQ_PHASE_BAL         , &ts.display_rx_iq, "RX IQ Phase   (160m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	...
	{ MENU_CONF, MENU_ITEM, CONFIG_60M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (60m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_60M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (60m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_40M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (40m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_40M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (40m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_30M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (30m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_30M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (30m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_20M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (20m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_20M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (20m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_17M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (17m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_17M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (17m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_15M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (15m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_15M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (15m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_12M_RX_IQ_GAIN_BAL           , &ts.display_rx_iq, "RX IQ Balance (12m)", UiMenuDesc("IQ Balance Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_12M_RX_IQ_PHASE_BAL          , &ts.display_rx_iq, "RX IQ Phase   (12m)", UiMenuDesc("IQ Phase Adjust for all receive if frequency translation is NOT OFF. Requires USB/LSB/CW mode to be changeable.See Wiki Adjustments and Calibration.") },
	...
	{ MENU_CONF, MENU_ITEM, CONFIG_160M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (160m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
    { MENU_CONF, MENU_ITEM, CONFIG_160M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (160m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	...
	{ MENU_CONF, MENU_ITEM, CONFIG_60M_TX_IQ_GAIN_BAL           , &vfo[0].enabled[BAND_MODE_60], "TX IQ Balance (60m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_60M_TX_IQ_PHASE_BAL          , &vfo[0].enabled[BAND_MODE_60], "TX IQ Phase   (60m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_40M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (40m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_40M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (40m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_30M_TX_IQ_GAIN_BAL           , &vfo[0].enabled[BAND_MODE_30], "TX IQ Balance (30m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_30M_TX_IQ_PHASE_BAL          , &vfo[0].enabled[BAND_MODE_30], "TX IQ Phase   (30m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_20M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (20m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_20M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (20m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_17M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (17m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_17M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (17m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_15M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (15m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_15M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (15m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_12M_TX_IQ_GAIN_BAL           , NULL, "TX IQ Balance (12m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
	{ MENU_CONF, MENU_ITEM, CONFIG_12M_TX_IQ_PHASE_BAL          , NULL, "TX IQ Phase   (12m)"   , UiMenuDesc("IQ Phase Adjust for all transmission if frequency translation is NOT OFF. Requires USB or LSB mode to be changeable. See Wiki Adjustments and Calibration.") },
...
const MenuDescriptor agcGroup[] =
{
	//  { MENU_AGC_WDSP, MENU_ITEM, MENU_RF_GAIN_ADJ            , NULL, "RF Gain"                , UiMenuDesc("RF Receive Gain. This setting is also accessible via Encoder 2, RFG.") }, // also via knob
	//  { MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_SWITCH        , NULL, "AGC Mode Switch"        , UiMenuDesc("You can choose between two different AGC systems here: ´Standard AGC´ and ´WDSP AGC´.") },
	//  { MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_MODE               , NULL, "AGC STD Mode"           , UiMenuDesc("Standard AGC: Automatic Gain Control Mode setting. You may select preconfigured settings (SLOW,MED,FAST), define settings yourself (CUSTOM) or use MANUAL (no AGC, use RFG to control gain") },
	//  { MENU_AGC_WDSP, MENU_ITEM, MENU_CUSTOM_AGC             , NULL, "AGC STD Custom Speed (+=Slower)", UiMenuDesc("Standard AGC:  If AGC STD Mode is set to CUSTOM, this controls the speed setting of AGC") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_MODE          , NULL, "AGC WDSP Mode"          , UiMenuDesc("Choose a bundle of preset AGC parameters for the WDSP AGC: FAST / MED / SLOW / LONG / very LONG or switch OFF the AGC.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_TAU_DECAY     , NULL, "AGC WDSP Decay"         , UiMenuDesc("Time constant for the AGC decay (speed of recovery of the AGC gain) in milliseconds.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_THRESH        , NULL, "AGC WDSP Threshold"     , UiMenuDesc("´Threshold´ = ´Knee´ of the AGC: input signal level from which on the AGC action takes place. AGC threshold should be placed/adjusted just above the band noise for every particular RX situation to allow for optimal AGC action. The blue AGC box indicates when AGC action takes place and helps in adjusting this threshold.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_ATTACK        , NULL, "AGC WDSP Attack"        , UiMenuDesc("Coeff d'attaque du AGC ") },

		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_SLOPE         , NULL, "AGC WDSP Slope"         , UiMenuDesc("Slope of the AGC is the difference between the loudest signal and the quietest signal after the AGC action has taken place. Given in dB.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_HANG_ENABLE   , NULL, "AGC WDSP Hang enable"   , UiMenuDesc("Enable/Disable Hang AGC function: If enabled: after the signal has decreased, the gain of the AGC is held constant for a certain time period (the hang time) in order to allow for speech pauses without disturbing noise because of fast acting AGC.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_HANG_TIME     , NULL, "AGC WDSP Hang time"     , UiMenuDesc("Hang AGC: hang time is the time period over which the AGC gain is held constant when in AGC Hang mode. After this period the gain is increased fast.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_HANG_THRESH   , NULL, "AGC WDSP Hang threshold", UiMenuDesc("´Threshold´ for the Hang AGC: Hang AGC is useful for medium to strong signals. The Hang threshold determines the signal strength a signal has to exceed for Hang AGC to take place.") },
		{ MENU_AGC_WDSP, MENU_ITEM, MENU_AGC_WDSP_TAU_HANG_DECAY, NULL, "AGC WDSP Hang Decay"    , UiMenuDesc("Time constant for the Hang AGC decay (speed of recovery of the AGC gain after hang time has expired) in milliseconds.") },
		{ MENU_AGC_WDSP, MENU_STOP,       0                     , NULL, NULL                     , UiMenuDesc("") }
};

const MenuDescriptor dspGroup[] =
{
	{ MENU_DSP, MENU_ITEM, MENU_NOISE_BLANKER_SETTING  , NULL, "RX NB Setting"          , UiMenuDesc("Set the Noise Blanker strength. Higher values mean more agressive blanking. Also changeable using Encoder 2 if Noise Blanker is active.") },
	{ MENU_DSP, MENU_ITEM, MENU_DSP_NR_STRENGTH        , NULL, "DSP NR Level"           , UiMenuDesc("Set the Noise Reduction Strength. Higher values mean more agressive noise reduction but also higher CPU load. Use with extreme care. Also changeable using Encoder 2 if DSP is active.") }, // via knob
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NEW_NB                     , NULL,"New Noiseblanker"         , UiMenuDesc("New noiseblanker for testing purposes") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_ENABLE                  , NULL,"Spectral NR"              , UiMenuDesc("enable spectral noise reduction for testing purposes") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_LONG_TONE_ENABLE        , NULL,"Long tone"                , UiMenuDesc("enable long tone detection in spectral noise reduction for testing purposes") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_GAIN_SHOW               , NULL,"Show gains"               , UiMenuDesc("Debugging: show gains of spectral noise reduction") },

	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_LONG_TONE_ALPHA         , NULL,"Long tone alpha"      , UiMenuDesc("time constant alpha for long tone detection in spectral noise reduction") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_LONG_TONE_THRESH        , NULL,"Long tone thresh"     , UiMenuDesc("threshold for long tone detection in spectral noise reduction") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_GAIN_SMOOTH_ENABLE      , NULL,"SNR gain smooth"      , UiMenuDesc("enable bin gain smoothing for spectral noise reduction for testing purposes") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_GAIN_SMOOTH_ALPHA       , NULL,"SNR gain smooth alpha", UiMenuDesc("alpha = smoothing constant for spectral noise reduction for testing purposes") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_ALPHA                   , NULL,"NR alpha"             , UiMenuDesc("time constant alpha for spectral noise reduction") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_THRESH                  , NULL,"NR thresh"            , UiMenuDesc("threshold for spectral noise reduction voice activity detector") },
	//  { MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_VAD_TYPE                , NULL,"NR VAD type"          , UiMenuDesc("VAD type for spectral noise reduction voice activity detector") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_VAD_DELAY               , NULL,"NR VAD delay"         , UiMenuDesc("delay for spectral noise reduction voice activity detector") },

		{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_BETA, NULL,"NR beta", UiMenuDesc("time constant beta for spectral noise reduction, leave at 0.85") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_Mode, NULL,"NR Mode", UiMenuDesc("switch between the released NR and two development NRs") },
		{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_ASNR, NULL,"NR asnr", UiMenuDesc("Devel 2 NR: asnr") },
	//#if defined(STM32F7) || defined(STM32H7)
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_FFT_SIZE, NULL,"NR FFT Size256", UiMenuDesc("enable FFT256 instead of FFT128 for devel2 NR") },
	//	{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_DEC_ENABLE, NULL,"NR decimation", UiMenuDesc("enable decimation-by-2 down to 6ksps for NR") },
	//#endif
		{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_GAIN_SMOOTH_WIDTH    , NULL,"NR smooth Width" , UiMenuDesc("Devel 2 NR: width of gain smoothing window") },
		{ MENU_DSP, MENU_ITEM, MENU_DEBUG_NR_GAIN_SMOOTH_THRESHOLD, NULL,"NR smooth threshold", UiMenuDesc("Devel 2 NR: threhold for gain smoothing") },

#ifdef USE_LMS_AUTONOTCH
	{ MENU_DSP, MENU_ITEM, CONFIG_DSP_NOTCH_CONVERGE_RATE             , NULL, "DSP Notch ConvRate" , UiMenuDesc("DSP LMS automatic notch filter: ") },
    { MENU_DSP, MENU_ITEM, CONFIG_DSP_NOTCH_DECORRELATOR_BUFFER_LENGTH, NULL, "DSP Notch BufLen"   , UiMenuDesc("DSP LMS automatic notch filter: length of the audio buffer that is used for simulation of a reference for the LMS algorithm. The longer the buffer, the better -and the slower- the performance, but this buffer length must always be larger than the number of taps in the FIR filter used. Thus, a larger buffer (and larger FIR filter) uses more MCU resources.") },
    { MENU_DSP, MENU_ITEM, CONFIG_DSP_NOTCH_FFT_NUMTAPS               , NULL, "DSP Notch FIRNumTap", UiMenuDesc("DSP LMS automatic notch filter: Number of taps in the DSP automatic notch FIR filter. The larger the number of taps in the filter, the better the performance, but the slower the performance of the filter and the mcHF.") },
#endif

	{ MENU_DSP, MENU_STOP,       0                     , NULL, NULL                     , UiMenuDesc("") }
};

const MenuDescriptor compressGroup[] =
{
	{ MENU_COMPRESS, MENU_ITEM, MENU_LINE_GAIN              , NULL, "TX Line Input Gain"       , UiMenuDesc("LineIn gain. Also changeable via Encoder 3 if LineIn Left (L>L) or LineIn Right (L>R) is selected as Input") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_MIC_LINE_MODE          , NULL, "TX Input Select"          , UiMenuDesc("Select the required signal input for transmit (except in CW). Also changeable via long press on M3") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_MIC_CODEC_GAIN         , NULL, "Mic 20dB Codec-Boost"     , UiMenuDesc("Microphone codec gain. Also changeable via Encoder 3 if Microphone is selected as Input") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_MIC_GAIN               , NULL, "Mic firmware Gain"        , UiMenuDesc("Microphone software  gain. Also changeable via Encoder 3 if Microphone is selected as Input") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_TX_COMPRESSION_LEVEL   , NULL, "Enable TX Compressor -->" , UiMenuDesc("Control the TX audio compressor. Higher values give more compression. Set to CUSTOM for user defined compression parameters. See below. Also changeable via Encoder 1 (CMP).") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_ALC_RELEASE            , NULL, "Compressor Release Time"  , UiMenuDesc("sets the value of the Audio Compressor Release time. Otherwise shows predefined value of selected compression level.") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_ALC_POSTFILT_GAIN      , NULL, "Compressor Input Gain"    , UiMenuDesc("sets the value of the compressor Input Gain. ") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_ALC_CMP_OUTPUT_GAIN    , NULL, "Compressor Ouput Gain"    , UiMenuDesc("sets the value of the compressor Output Gain. ") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_MIC_NOISE_GATE_THRESH  , NULL, "Mic Noise Gate Thresh"    , UiMenuDesc("sets the value of the Microphone Noise Gate threshold. ") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_REVERBERATION_ENABLE   , NULL, "Mic Reverberation "       , UiMenuDesc("Tx Mic voice reverberation effect to enable/disable ") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_REVERBERATION_RATE     , NULL, "Mic Reverberat.Rate"      , UiMenuDesc("Tx Mic voice reverberation effect rate from 1% to 25% ") },
	{ MENU_COMPRESS, MENU_ITEM, MENU_REVERBERATION_DELAY    , NULL, "Mic Reverberat.Delay"     , UiMenuDesc("Tx Mic voice reverberation delay from 20 ms to 80 ms ") },
	{ MENU_COMPRESS, MENU_STOP,       0                     , NULL,  NULL                      , UiMenuDesc("") }
};


const MenuDescriptor displayGroup[] =
{
	{ MENU_DISPLAY, MENU_ITEM, MENU_DBM_CALIBRATE               , NULL, "Smeter calibrate"        , UiMenuDesc("dBm display calibration. Just an offset (in dB) that is added to the internally calculated dBm or dBm/Hz value.")},
...
//	{ MENU_DISPLAY, MENU_ITEM, MENU_SPECTRUM_SIZE               , NULL, "Spectrum Size"        , UiMenuDesc("Change height of spectrum display") },
	{ MENU_DISPLAY, MENU_ITEM, MENU_WFALL_SPEED                 , NULL, "Wfall Speed"          , UiMenuDesc("Lower Values: Higher refresh rate. Set to 0 to disable waterfall.") },
	{ MENU_DISPLAY, MENU_ITEM, MENU_SCOPE_SPEED                 , NULL, "Scope Speed"          , UiMenuDesc("Lower Values: Higher refresh rate. Set to 0 to disable scope.") },
...
//  { MENU_DISPLAY, MENU_ITEM, CONFIG_SPECTRUM_FFT_WINDOW_TYPE  , NULL, "Spectrum FFT Wind."   , UiMenuDesc("Selects the window algorithm for the spectrum FFT. For low spectral leakage, Hann, Hamming or Blackman window is recommended.") },
	...
	{ MENU_DISPLAY, MENU_ITEM, MENU_SCOPE_BACKGROUND_HL_TRANSP  , NULL, "Scope BW BCKgr transp", UiMenuDesc("Set colour of highlighted BW background") },
...
{
	{ MENU_FILTER, MENU_ITEM, MENU_RX_HP_FILTER               , NULL, "Rx Audio HP Filter"     , UiMenuDesc("High pass Filter cut off audio frequency ") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_BASS_EQUAL_FREQ   , NULL, "SSB RX EQ Bass Freq"    , UiMenuDesc("Select Bass freq for Equalizer SSB Rx Audio filter )") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_BASS_EQUAL_GAIN   , NULL, "SSB RX EQ Bass Gain"    , UiMenuDesc("Select Bass freq Gain for Equalizer SSB Rx Audio filter )") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_BASS_EQUAL_BWIDTH , NULL, "SSB RX EQ Bass Sharp"   , UiMenuDesc("Select Bass freq bandwidth for Equalizer SSB Rx Audio filter )") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_TREBL_EQUAL_FREQ  , NULL, "SSB RX EQ Trebl Freq"   , UiMenuDesc("Select treble freq for Equalizer SSB Rx Audio filter )") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_TREBL_EQUAL_GAIN  , NULL, "SSB RX EQ Trebl Gain"   , UiMenuDesc("Select treble freq Gain for Equalizer SSB Rx Audio filter )") },
	{ MENU_FILTER, MENU_ITEM, CONFIG_SSB_RX_TREBL_EQUAL_BWIDTH, NULL, "SSB RX EQ Trebl Sharp"  , UiMenuDesc("Select treble freq bandwidth for Equalizer SSB Rx Audio filter )") },
...
const MenuDescriptor txfilterGroup[] =
{
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_AM_TX_FILTER_DISABLE      , NULL, "AM  TX Audio Filter"    , UiMenuDesc("Select if AM-TX signal is filtered (strongly recommended to agree to regulations)") },
//  { MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_FILTER_DISABLE     , NULL, "SSB TX Audio Filter"    , UiMenuDesc(":soon:") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_HPF_FILTER         , NULL, "SSB TX Voice HPF"       , UiMenuDesc("Select if SSB-TX signal is filtered (strongly recommended to agree to regulations)") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_FILTER             , NULL, "SSB TX Voice Filter"    , UiMenuDesc("Select if SSB-TX signal is filtered (strongly recommended to agree to regulations)") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_BASS_FILTER_FREQ   , NULL, "SSB TX EQ Bass Freq"    , UiMenuDesc("Select Bass freq for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_BASS_FILTER_GAIN   , NULL, "SSB TX EQ Bass Gain"    , UiMenuDesc("Select Bass freq Gain for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_BASS_FILTER_BWIDTH , NULL, "SSB TX EQ Bass Sharp"   , UiMenuDesc("Select Bass freq bandwidth for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_BASS_SHEEFT        , NULL, "SSB TX/Rx Bass Sheeft"  , UiMenuDesc("Select Tx/Rx freq Sheeft to get more Bass feeling )") },

	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_MEDIUM_FILTER_FREQ  , NULL, "SSB TX EQ Medium Freq"   , UiMenuDesc("Select Medium freq for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_MEDIUM_FILTER_GAIN  , NULL, "SSB TX EQ Medium Gain"   , UiMenuDesc("Select Medium freq Gain for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_MEDIUM_FILTER_BWIDTH, NULL, "SSB TX EQ Medium Sharp"  , UiMenuDesc("Select Medium freq bandwidth for Equalizer SSB Tx Audio filter )") },

	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_TREB_FILTER_FREQ   , NULL, "SSB TX EQ Trebl Freq"  , UiMenuDesc("Select Treble freq for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_TREB_FILTER_GAIN   , NULL, "SSB TX EQ Trebl Gain"  , UiMenuDesc("Select Treble freq Gain for Equalizer SSB Tx Audio filter )") },
	{ MENU_TX_FILTER, MENU_ITEM, CONFIG_SSB_TX_TREB_FILTER_BWIDTH , NULL, "SSB TX EQ Trebl Sharp", UiMenuDesc("Select Bass Treble bandwidth for Equalizer SSB Tx Audio filter )") },

	{ MENU_TX_FILTER, MENU_STOP, 0, NULL, NULL, UiMenuDesc("") }
};
...
//  { MENU_POW, MENU_ITEM, CONFIG_2200M_FULL_POWER_ADJUST,&vfo[0].enabled[BAND_MODE_2200],"2200m Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
//	{ MENU_POW, MENU_ITEM, CONFIG_630M_FULL_POWER_ADJUST,&vfo[0].enabled[BAND_MODE_630],"630m  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_60M_FULL_POWER_ADJUST     ,&vfo[0].enabled[BAND_MODE_60], "60m   Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_30M_FULL_POWER_ADJUST     , &vfo[0].enabled[BAND_MODE_30], "30m   Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_6M_FULL_POWER_ADJUST  ,&vfo[0].enabled[BAND_MODE_6],"6m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	{ MENU_POW, MENU_ITEM, CONFIG_4M_FULL_POWER_ADJUST  ,&vfo[0].enabled[BAND_MODE_4],"4m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	{ MENU_POW, MENU_ITEM, CONFIG_2M_FULL_POWER_ADJUST  ,&vfo[0].enabled[BAND_MODE_2],"2m    Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	{ MENU_POW, MENU_ITEM, CONFIG_70CM_FULL_POWER_ADJUST,&vfo[0].enabled[BAND_MODE_70],"70cm  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
	{ MENU_POW, MENU_ITEM, CONFIG_23CM_FULL_POWER_ADJUST,&vfo[0].enabled[BAND_MODE_23],"23cm  Full PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve full power on this band. Check the output signal when adjusting for full power! See Adjustment and Calibration for more information.") },
//	{ MENU_POW, MENU_ITEM, CONFIG_2200M_5W_ADJUST       ,&vfo[0].enabled[BAND_MODE_2200],"2200m 5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
//  { MENU_POW, MENU_ITEM, CONFIG_630M_5W_ADJUST        ,&vfo[0].enabled[BAND_MODE_630],"630m  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_60M_5W_ADJUST         ,&vfo[0].enabled[BAND_MODE_60], "60m   5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_30M_5W_ADJUST         ,&vfo[0].enabled[BAND_MODE_30], "30m   5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    ...
    { MENU_POW, MENU_ITEM, CONFIG_6M_5W_ADJUST          ,&vfo[0].enabled[BAND_MODE_6],"6m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_4M_5W_ADJUST          ,&vfo[0].enabled[BAND_MODE_4],"4m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_2M_5W_ADJUST          ,&vfo[0].enabled[BAND_MODE_2],"2m    5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_70CM_5W_ADJUST        ,&vfo[0].enabled[BAND_MODE_70],"70cm  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },
    { MENU_POW, MENU_ITEM, CONFIG_23CM_5W_ADJUST        ,&vfo[0].enabled[BAND_MODE_23],"23cm  5W PWR Adjust", UiMenuDesc("Defines the internal power adjustment factor to achieve 5W power on this band. See Adjustment and Calibration for more information.") },

	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_PWR_DISP        , NULL, "Pwr. Display mW"           , UiMenuDesc("Shows the forward and reverse power values in mW, can be used to calibrate the SWR meter.") },
	{ MENU_POW, MENU_ITEM, CONFIG_RF_FWD_PWR_NULL         , NULL, "Pwr. Det. Null"            , UiMenuDesc(" Set the forward and reverse power sensors ADC zero power offset. This setting is enabled ONLY when Disp. Pwr (mW), is enabled. Needs SWR meter hardware modification to work. See Wiki Adjustment and Calibration.") },
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_SENSE_SWAP      , NULL, "SWR/PWR Meter FWD/REV Swap", UiMenuDesc("Exchange the assignment of the Power/SWR FWD and REV measurement ADC. Use if your power meter does not show anything during TX.") },
//	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2200M_ADJ,&vfo[0].enabled[BAND_MODE_2200],"2200m Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 2200m band power values. See Wiki.") },
//  { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_630M_ADJ,&vfo[0].enabled[BAND_MODE_630],"630m Coupling Adj.", UiMenuDesc("Power Adjustment factor for the 630m band power values. See Wiki.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_60M_ADJ, &vfo[0].enabled[BAND_MODE_60], "60m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 60m and 60m band power values. See Wiki.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_30M_ADJ, &vfo[0].enabled[BAND_MODE_30], "30m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 30m and 60m band power values. See Wiki.") },
	...
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_17M_ADJ, NULL, "17m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 40m and 60m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_15M_ADJ, NULL, "15m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 15m bands power values. See Wiki.") },
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_12M_ADJ, NULL, "12m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 12m bands power values. See Wiki.") },
	{ MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_10M_ADJ, NULL, "10m  Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 10m bands power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_6M_ADJ  ,&vfo[0].enabled[BAND_MODE_6], "6m   Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 6m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_2M_ADJ  ,&vfo[0].enabled[BAND_MODE_2], "2m   Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 2m band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_70CM_ADJ,&vfo[0].enabled[BAND_MODE_70], "70cm Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 70cm band power values. See Wiki.") },
    { MENU_POW, MENU_ITEM, CONFIG_FWD_REV_COUPLING_23CM_ADJ,&vfo[0].enabled[BAND_MODE_23], "23cm Coupling Adj.", UiMenuDesc("Power Meter Adjustment factor for the 23cm band power values. See Wiki.") },

	  // NIZZZ on a pas besoin de cet option qui complique le menu et l'exploitation , puisque"on a un bouton Pow qui peut faire changer la puissance rapidement
...
MenuGroupState agcGroupState;
MenuGroupState filterGroupState;
MenuGroupState txfilterGroupState;
MenuGroupState compressGroupState;
MenuGroupState displayGroupState;
MenuGroupState cwGroupState;
MenuGroupState powGroupState;
MenuGroupState dspGroupState;
...
const MenuGroupDescriptor groups[] =
{
	...
	{ agcGroup         , &agcGroupState         , topGroup },  // Group 3
	{ filterGroup      , &filterGroupState      , topGroup },  // Group 8
	{ txfilterGroup    , &txfilterGroupState    , topGroup },  // Group 9
	{ compressGroup    , &compressGroupState    , topGroup },  // Group 5
    { displayGroup     , &displayGroupState     , topGroup },  // Group 6
    { cwGroup          , &cwGroupState          , topGroup },  // Group 7
    { powGroup         , &powGroupState         , topGroup },  // Group 10
	{ dspGroup         , &dspGroupState         , topGroup },  // Group 4
 //   { men2touchGroup   , &men2touchState        , topGroup },  // Group 11
    { infoGroup        , &infoGroupState        , topGroup },  // Group 12
    { debugGroup       , &debugGroupState       , topGroup },  // Group 13
    { hall_of_fameGroup, &hall_of_fameGroupState, topGroup },  // Group 14
};
