...
void BL_Application()
{
    switch ( Appli_state )
    {
		case APPLICATION_READY     :  BL_MSC_Application();	               Appli_state = APPLICATION_IDLE;		  break;
		case APPLICATION_DISCONNECT:  f_mount(NULL, (TCHAR const*)"", 0);  Appli_state = APPLICATION_IDLE;		  break;
